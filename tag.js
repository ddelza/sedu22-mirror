...
- 과학 수업 단원 내용이 아니라 과학 교사로서의 업무/행정에 관한 글(과학의 달/과학경진대회 등 행사 기획·운영, 실험실/기자재/약품 등 과학실 관리, 과학 동아리·발명동아리 등 동아리 운영, 직무연수·자율연수 등 교원연수 안내, 모둠/조 편성·자리배치·학급 규칙·보상제도(도장/강화물)·발표자 선정·경청 지도·담임 상담 등 학급운영)이면 아래처럼 category/topic 태그를 쓴다. topic은 "과학 행사"/"과학실 관리"/"동아리 운영"/"교원연수"/"학급운영" 중 하나:
...
- 특정 도구가 아니라 수업을 설계·진행하는 방식(교수법) 자체가 주제인 글이면 아래처럼 category/topic 태그를 쓴다. topic은 "거꾸로 교실"(Flipped Classroom), "IB(개념기반학습)"(IB 교육과정, 개념기반 탐구학습), "배움중심수업"(경기도 등에서 쓰는 학생 주도 활동 중심 수업, 활동지 제목에 "배움중심수업/배움중심 수업 활동지"라고 명시된 경우) 등 — 새로운 교수법 패턴이 보이면 그 이름으로 topic을 추가한다:
